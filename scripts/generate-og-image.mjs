...
// Satori reads font data directly (no system fonts). The same static-weight
// buffer is registered at every weight the layout references; any fontWeight
// in the JSX maps to it.
...
const ogTree = h(
  ...
  h(
    ...
    h(
      'div',
      { style: { display: 'flex', fontSize: '34px', fontWeight: 600, letterSpacing: '-0.02em' } },
      'OpenSignup',
    ),
  ),
  h(
