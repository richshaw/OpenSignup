...
export default async function SettingsTab({ params, searchParams }: PageParams) {
  ...
  // Always names one of the date fields while the signup has any: the services
  // keep it that way, so there is no "none" option to render.
        ...
        >
          <div>
            ...
            <p className="mt-1 text-sm text-ink-muted">
              Send participants a reminder email the day before their slot.
            </p>
          </div>
          {/*
          ...
          <label className="flex items-start gap-3">
            ...
            <span className="text-sm">
              ...
              <span className="block text-ink-muted">
                Off means no reminders go out for this signup. Participants can also opt out
                individually from any reminder they get.
              </span>
            </span>
          </label>
